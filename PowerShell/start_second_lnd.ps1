Remove-Item 'C:\Users\Andriy\Documents\lnd_python_regtest\src\lnd_data' -Recurse -ErrorAction SilentlyContinue
...
Start-Process -Wait -FilePath $lncli_path/lncli.exe -ArgumentList "--rpcserver=localhost:10010 --lnddir=C:\Users\Andriy\Documents\lnd_python_regtest\src\lnd_data --chain bitcoin --network regtest create"

Write-Output "Waiting after wallet creation 10s"
Start-Sleep -s 10
