...
static const char* WalletUnlocker_method_names[] = {
...
std::unique_ptr< WalletUnlocker::Stub> WalletUnlocker::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< WalletUnlocker::Stub> stub(new WalletUnlocker::Stub(channel));
  return stub;
}

WalletUnlocker::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_GenSeed_(WalletUnlocker_method_names[0], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_InitWallet_(WalletUnlocker_method_names[1], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UnlockWallet_(WalletUnlocker_method_names[2], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ChangePassword_(WalletUnlocker_method_names[3], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}

::grpc::Status WalletUnlocker::Stub::GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::lnrpc::GenSeedResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GenSeed_, context, request, response);
}

void WalletUnlocker::Stub::experimental_async::GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GenSeed_, context, request, response, std::move(f));
}

void WalletUnlocker::Stub::experimental_async::GenSeed(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::GenSeedResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GenSeed_, context, request, response, std::move(f));
}

void WalletUnlocker::Stub::experimental_async::GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_GenSeed_, context, request, response, reactor);
}

void WalletUnlocker::Stub::experimental_async::GenSeed(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::GenSeedResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_GenSeed_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::lnrpc::GenSeedResponse>* WalletUnlocker::Stub::AsyncGenSeedRaw(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::lnrpc::GenSeedResponse>::Create(channel_.get(), cq, rpcmethod_GenSeed_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::lnrpc::GenSeedResponse>* WalletUnlocker::Stub::PrepareAsyncGenSeedRaw(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::lnrpc::GenSeedResponse>::Create(channel_.get(), cq, rpcmethod_GenSeed_, context, request, false);
}

::grpc::Status WalletUnlocker::Stub::InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::lnrpc::InitWalletResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_InitWallet_, context, request, response);
}

void WalletUnlocker::Stub::experimental_async::InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_InitWallet_, context, request, response, std::move(f));
}

void WalletUnlocker::Stub::experimental_async::InitWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::InitWalletResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_InitWallet_, context, request, response, std::move(f));
}

void WalletUnlocker::Stub::experimental_async::InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_InitWallet_, context, request, response, reactor);
}

void WalletUnlocker::Stub::experimental_async::InitWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::InitWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_InitWallet_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::lnrpc::InitWalletResponse>* WalletUnlocker::Stub::AsyncInitWalletRaw(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::lnrpc::InitWalletResponse>::Create(channel_.get(), cq, rpcmethod_InitWallet_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::lnrpc::InitWalletResponse>* WalletUnlocker::Stub::PrepareAsyncInitWalletRaw(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::lnrpc::InitWalletResponse>::Create(channel_.get(), cq, rpcmethod_InitWallet_, context, request, false);
}

::grpc::Status WalletUnlocker::Stub::UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::lnrpc::UnlockWalletResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_UnlockWallet_, context, request, response);
}

void WalletUnlocker::Stub::experimental_async::UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_UnlockWallet_, context, request, response, std::move(f));
}

void WalletUnlocker::Stub::experimental_async::UnlockWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::UnlockWalletResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_UnlockWallet_, context, request, response, std::move(f));
}

void WalletUnlocker::Stub::experimental_async::UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_UnlockWallet_, context, request, response, reactor);
}

void WalletUnlocker::Stub::experimental_async::UnlockWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::UnlockWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_UnlockWallet_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::lnrpc::UnlockWalletResponse>* WalletUnlocker::Stub::AsyncUnlockWalletRaw(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::lnrpc::UnlockWalletResponse>::Create(channel_.get(), cq, rpcmethod_UnlockWallet_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::lnrpc::UnlockWalletResponse>* WalletUnlocker::Stub::PrepareAsyncUnlockWalletRaw(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::lnrpc::UnlockWalletResponse>::Create(channel_.get(), cq, rpcmethod_UnlockWallet_, context, request, false);
}

::grpc::Status WalletUnlocker::Stub::ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::lnrpc::ChangePasswordResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_ChangePassword_, context, request, response);
}

void WalletUnlocker::Stub::experimental_async::ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response, std::function<void(::grpc::Status)> f) {
...
void WalletUnlocker::Stub::experimental_async::ChangePassword(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::ChangePasswordResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_ChangePassword_, context, request, response, std::move(f));
}

void WalletUnlocker::Stub::experimental_async::ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
void WalletUnlocker::Stub::experimental_async::ChangePassword(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::ChangePasswordResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_ChangePassword_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::lnrpc::ChangePasswordResponse>* WalletUnlocker::Stub::AsyncChangePasswordRaw(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::lnrpc::ChangePasswordResponse>::Create(channel_.get(), cq, rpcmethod_ChangePassword_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::lnrpc::ChangePasswordResponse>* WalletUnlocker::Stub::PrepareAsyncChangePasswordRaw(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::lnrpc::ChangePasswordResponse>::Create(channel_.get(), cq, rpcmethod_ChangePassword_, context, request, false);
}

WalletUnlocker::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      WalletUnlocker_method_names[0],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< WalletUnlocker::Service, ::lnrpc::GenSeedRequest, ::lnrpc::GenSeedResponse>(
          std::mem_fn(&WalletUnlocker::Service::GenSeed), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      WalletUnlocker_method_names[1],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< WalletUnlocker::Service, ::lnrpc::InitWalletRequest, ::lnrpc::InitWalletResponse>(
          std::mem_fn(&WalletUnlocker::Service::InitWallet), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      WalletUnlocker_method_names[2],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< WalletUnlocker::Service, ::lnrpc::UnlockWalletRequest, ::lnrpc::UnlockWalletResponse>(
          std::mem_fn(&WalletUnlocker::Service::UnlockWallet), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      WalletUnlocker_method_names[3],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< WalletUnlocker::Service, ::lnrpc::ChangePasswordRequest, ::lnrpc::ChangePasswordResponse>(
          std::mem_fn(&WalletUnlocker::Service::ChangePassword), this)));
}

WalletUnlocker::Service::~Service() {
}

::grpc::Status WalletUnlocker::Service::GenSeed(::grpc::ServerContext* context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response) {
  (void) context;
  (void) request;
  (void) response;
...
::grpc::Status WalletUnlocker::Service::InitWallet(::grpc::ServerContext* context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status WalletUnlocker::Service::UnlockWallet(::grpc::ServerContext* context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status WalletUnlocker::Service::ChangePassword(::grpc::ServerContext* context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
Lightning::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_PendingChannels_(Lightning_method_names[16], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListChannels_(Lightning_method_names[17], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SubscribeChannelEvents_(Lightning_method_names[18], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_ClosedChannels_(Lightning_method_names[19], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_OpenChannelSync_(Lightning_method_names[20], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_OpenChannel_(Lightning_method_names[21], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_FundingStateStep_(Lightning_method_names[22], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ChannelAcceptor_(Lightning_method_names[23], ::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  , rpcmethod_CloseChannel_(Lightning_method_names[24], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_AbandonChannel_(Lightning_method_names[25], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SendPayment_(Lightning_method_names[26], ::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  , rpcmethod_SendPaymentSync_(Lightning_method_names[27], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SendToRoute_(Lightning_method_names[28], ::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  , rpcmethod_SendToRouteSync_(Lightning_method_names[29], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_AddInvoice_(Lightning_method_names[30], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListInvoices_(Lightning_method_names[31], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_LookupInvoice_(Lightning_method_names[32], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SubscribeInvoices_(Lightning_method_names[33], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_DecodePayReq_(Lightning_method_names[34], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListPayments_(Lightning_method_names[35], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteAllPayments_(Lightning_method_names[36], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DescribeGraph_(Lightning_method_names[37], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetNodeMetrics_(Lightning_method_names[38], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetChanInfo_(Lightning_method_names[39], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetNodeInfo_(Lightning_method_names[40], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_QueryRoutes_(Lightning_method_names[41], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetNetworkInfo_(Lightning_method_names[42], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_StopDaemon_(Lightning_method_names[43], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SubscribeChannelGraph_(Lightning_method_names[44], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_DebugLevel_(Lightning_method_names[45], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_FeeReport_(Lightning_method_names[46], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateChannelPolicy_(Lightning_method_names[47], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ForwardingHistory_(Lightning_method_names[48], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ExportChannelBackup_(Lightning_method_names[49], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ExportAllChannelBackups_(Lightning_method_names[50], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_VerifyChanBackup_(Lightning_method_names[51], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RestoreChannelBackups_(Lightning_method_names[52], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SubscribeChannelBackups_(Lightning_method_names[53], ::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_BakeMacaroon_(Lightning_method_names[54], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
