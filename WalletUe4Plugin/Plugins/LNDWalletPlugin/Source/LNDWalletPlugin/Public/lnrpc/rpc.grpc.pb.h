...
class WalletUnlocker final {
 public:
  static constexpr char const* service_full_name() {
    return "lnrpc.WalletUnlocker";
  }
  class StubInterface {
   public:
    ...
    // wallet.
    virtual ::grpc::Status GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::lnrpc::GenSeedResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::GenSeedResponse>> AsyncGenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::GenSeedResponse>>(AsyncGenSeedRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::GenSeedResponse>> PrepareAsyncGenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::GenSeedResponse>>(PrepareAsyncGenSeedRaw(context, request, cq));
    }
    // *
    ...
    virtual ::grpc::Status InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::lnrpc::InitWalletResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::InitWalletResponse>> AsyncInitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::InitWalletResponse>>(AsyncInitWalletRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::InitWalletResponse>> PrepareAsyncInitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::InitWalletResponse>>(PrepareAsyncInitWalletRaw(context, request, cq));
    }
    // * lncli: `unlock`
    // UnlockWallet is used at startup of lnd to provide a password to unlock
    // the wallet database.
    virtual ::grpc::Status UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::lnrpc::UnlockWalletResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::UnlockWalletResponse>> AsyncUnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::UnlockWalletResponse>>(AsyncUnlockWalletRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::UnlockWalletResponse>> PrepareAsyncUnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::UnlockWalletResponse>>(PrepareAsyncUnlockWalletRaw(context, request, cq));
    }
    // * lncli: `changepassword`
    // ChangePassword changes the password of the encrypted wallet. This will
    // automatically unlock the wallet database if successful.
    virtual ::grpc::Status ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::lnrpc::ChangePasswordResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::ChangePasswordResponse>> AsyncChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::ChangePasswordResponse>>(AsyncChangePasswordRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::ChangePasswordResponse>> PrepareAsyncChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::ChangePasswordResponse>>(PrepareAsyncChangePasswordRaw(context, request, cq));
    }
    class experimental_async_interface {
     public:
      ...
      // method should be used to commit the newly generated seed, and create the
      // wallet.
      virtual void GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GenSeed(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::GenSeedResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void GenSeed(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::GenSeedResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void GenSeed(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::GenSeedResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // *
      // InitWallet is used when lnd is starting up for the first time to fully
      // initialize the daemon and its internal wallet. At the very least a wallet
      ...
      // seed, then present it to the user. Once it has been verified by the user,
      // the seed can be fed into this RPC in order to commit the new wallet.
      virtual void InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void InitWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::InitWalletResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void InitWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::InitWalletResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void InitWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::InitWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // * lncli: `unlock`
      // UnlockWallet is used at startup of lnd to provide a password to unlock
      // the wallet database.
      virtual void UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void UnlockWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::UnlockWalletResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void UnlockWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::UnlockWalletResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void UnlockWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::UnlockWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // * lncli: `changepassword`
      // ChangePassword changes the password of the encrypted wallet. This will
      // automatically unlock the wallet database if successful.
      virtual void ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void ChangePassword(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::ChangePasswordResponse* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void ChangePassword(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::ChangePasswordResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void ChangePassword(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::ChangePasswordResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  ...
  private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::GenSeedResponse>* AsyncGenSeedRaw(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::GenSeedResponse>* PrepareAsyncGenSeedRaw(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::InitWalletResponse>* AsyncInitWalletRaw(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::InitWalletResponse>* PrepareAsyncInitWalletRaw(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::UnlockWalletResponse>* AsyncUnlockWalletRaw(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::UnlockWalletResponse>* PrepareAsyncUnlockWalletRaw(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::ChangePasswordResponse>* AsyncChangePasswordRaw(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::lnrpc::ChangePasswordResponse>* PrepareAsyncChangePasswordRaw(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel);
    ::grpc::Status GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::lnrpc::GenSeedResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::GenSeedResponse>> AsyncGenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::GenSeedResponse>>(AsyncGenSeedRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::GenSeedResponse>> PrepareAsyncGenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::GenSeedResponse>>(PrepareAsyncGenSeedRaw(context, request, cq));
    }
    ::grpc::Status InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::lnrpc::InitWalletResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::InitWalletResponse>> AsyncInitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::InitWalletResponse>>(AsyncInitWalletRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::InitWalletResponse>> PrepareAsyncInitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::InitWalletResponse>>(PrepareAsyncInitWalletRaw(context, request, cq));
    }
    ::grpc::Status UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::lnrpc::UnlockWalletResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::UnlockWalletResponse>> AsyncUnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::UnlockWalletResponse>>(AsyncUnlockWalletRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::UnlockWalletResponse>> PrepareAsyncUnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::UnlockWalletResponse>>(PrepareAsyncUnlockWalletRaw(context, request, cq));
    }
    ::grpc::Status ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::lnrpc::ChangePasswordResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::ChangePasswordResponse>> AsyncChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::ChangePasswordResponse>>(AsyncChangePasswordRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::ChangePasswordResponse>> PrepareAsyncChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::lnrpc::ChangePasswordResponse>>(PrepareAsyncChangePasswordRaw(context, request, cq));
    }
    class experimental_async final :
      public StubInterface::experimental_async_interface {
     public:
      void GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response, std::function<void(::grpc::Status)>) override;
      void GenSeed(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::GenSeedResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void GenSeed(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void GenSeed(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::GenSeedResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void GenSeed(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::GenSeedResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      void InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response, std::function<void(::grpc::Status)>) override;
      void InitWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::InitWalletResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void InitWallet(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void InitWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::InitWalletResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void InitWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::InitWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      void UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response, std::function<void(::grpc::Status)>) override;
      void UnlockWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::UnlockWalletResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void UnlockWallet(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void UnlockWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::UnlockWalletResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void UnlockWallet(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::UnlockWalletResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      void ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response, std::function<void(::grpc::Status)>) override;
      void ChangePassword(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::ChangePasswordResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void ChangePassword(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void ChangePassword(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::ChangePasswordResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void ChangePassword(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::lnrpc::ChangePasswordResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::lnrpc::GenSeedResponse>* AsyncGenSeedRaw(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::lnrpc::GenSeedResponse>* PrepareAsyncGenSeedRaw(::grpc::ClientContext* context, const ::lnrpc::GenSeedRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::lnrpc::InitWalletResponse>* AsyncInitWalletRaw(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::lnrpc::InitWalletResponse>* PrepareAsyncInitWalletRaw(::grpc::ClientContext* context, const ::lnrpc::InitWalletRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::lnrpc::UnlockWalletResponse>* AsyncUnlockWalletRaw(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::lnrpc::UnlockWalletResponse>* PrepareAsyncUnlockWalletRaw(::grpc::ClientContext* context, const ::lnrpc::UnlockWalletRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::lnrpc::ChangePasswordResponse>* AsyncChangePasswordRaw(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::lnrpc::ChangePasswordResponse>* PrepareAsyncChangePasswordRaw(::grpc::ClientContext* context, const ::lnrpc::ChangePasswordRequest& request, ::grpc::CompletionQueue* cq) override;
    const ::grpc::internal::RpcMethod rpcmethod_GenSeed_;
    const ::grpc::internal::RpcMethod rpcmethod_InitWallet_;
    const ::grpc::internal::RpcMethod rpcmethod_UnlockWallet_;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // method should be used to commit the newly generated seed, and create the
    // wallet.
    virtual ::grpc::Status GenSeed(::grpc::ServerContext* context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response);
    // *
    // InitWallet is used when lnd is starting up for the first time to fully
    // initialize the daemon and its internal wallet. At the very least a wallet
    // password must be provided. This will be used to encrypt sensitive material
    ...
    // seed, then present it to the user. Once it has been verified by the user,
    // the seed can be fed into this RPC in order to commit the new wallet.
    virtual ::grpc::Status InitWallet(::grpc::ServerContext* context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response);
    // * lncli: `unlock`
    // UnlockWallet is used at startup of lnd to provide a password to unlock
    // the wallet database.
    virtual ::grpc::Status UnlockWallet(::grpc::ServerContext* context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response);
    // * lncli: `changepassword`
    // ChangePassword changes the password of the encrypted wallet. This will
    // automatically unlock the wallet database if successful.
    virtual ::grpc::Status ChangePassword(::grpc::ServerContext* context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response);
  };
  template <class BaseClass>
  class WithAsyncMethod_GenSeed : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_GenSeed() {
      ::grpc::Service::MarkMethodAsync(0);
    }
    ~WithAsyncMethod_GenSeed() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GenSeed(::grpc::ServerContext* /*context*/, const ::lnrpc::GenSeedRequest* /*request*/, ::lnrpc::GenSeedResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGenSeed(::grpc::ServerContext* context, ::lnrpc::GenSeedRequest* request, ::grpc::ServerAsyncResponseWriter< ::lnrpc::GenSeedResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithAsyncMethod_InitWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_InitWallet() {
      ::grpc::Service::MarkMethodAsync(1);
    }
    ~WithAsyncMethod_InitWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status InitWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::InitWalletRequest* /*request*/, ::lnrpc::InitWalletResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestInitWallet(::grpc::ServerContext* context, ::lnrpc::InitWalletRequest* request, ::grpc::ServerAsyncResponseWriter< ::lnrpc::InitWalletResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(1, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithAsyncMethod_UnlockWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_UnlockWallet() {
      ::grpc::Service::MarkMethodAsync(2);
    }
    ~WithAsyncMethod_UnlockWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UnlockWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::UnlockWalletRequest* /*request*/, ::lnrpc::UnlockWalletResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestUnlockWallet(::grpc::ServerContext* context, ::lnrpc::UnlockWalletRequest* request, ::grpc::ServerAsyncResponseWriter< ::lnrpc::UnlockWalletResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  class WithAsyncMethod_ChangePassword : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status ChangePassword(::grpc::ServerContext* /*context*/, const ::lnrpc::ChangePasswordRequest* /*request*/, ::lnrpc::ChangePasswordResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestChangePassword(::grpc::ServerContext* context, ::lnrpc::ChangePasswordRequest* request, ::grpc::ServerAsyncResponseWriter< ::lnrpc::ChangePasswordResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(3, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_GenSeed<WithAsyncMethod_InitWallet<WithAsyncMethod_UnlockWallet<WithAsyncMethod_ChangePassword<Service > > > > AsyncService;
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_GenSeed : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_GenSeed() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::lnrpc::GenSeedRequest, ::lnrpc::GenSeedResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
                     context, const ::lnrpc::GenSeedRequest* request, ::lnrpc::GenSeedResponse* response) { return this->GenSeed(context, request, response); }));}
    void SetMessageAllocatorFor_GenSeed(
        ::grpc::experimental::MessageAllocator< ::lnrpc::GenSeedRequest, ::lnrpc::GenSeedResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(0);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::lnrpc::GenSeedRequest, ::lnrpc::GenSeedResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_GenSeed() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GenSeed(::grpc::ServerContext* /*context*/, const ::lnrpc::GenSeedRequest* /*request*/, ::lnrpc::GenSeedResponse* /*response*/) override {
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerUnaryReactor* GenSeed(
      ::grpc::CallbackServerContext* /*context*/, const ::lnrpc::GenSeedRequest* /*request*/, ::lnrpc::GenSeedResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* GenSeed(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::lnrpc::GenSeedRequest* /*request*/, ::lnrpc::GenSeedResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_InitWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_InitWallet() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(1,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::lnrpc::InitWalletRequest, ::lnrpc::InitWalletResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::lnrpc::InitWalletRequest* request, ::lnrpc::InitWalletResponse* response) { return this->InitWallet(context, request, response); }));}
    void SetMessageAllocatorFor_InitWallet(
        ::grpc::experimental::MessageAllocator< ::lnrpc::InitWalletRequest, ::lnrpc::InitWalletResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(1);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(1);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::lnrpc::InitWalletRequest, ::lnrpc::InitWalletResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_InitWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status InitWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::InitWalletRequest* /*request*/, ::lnrpc::InitWalletResponse* /*response*/) override {
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerUnaryReactor* InitWallet(
      ::grpc::CallbackServerContext* /*context*/, const ::lnrpc::InitWalletRequest* /*request*/, ::lnrpc::InitWalletResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* InitWallet(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::lnrpc::InitWalletRequest* /*request*/, ::lnrpc::InitWalletResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_UnlockWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_UnlockWallet() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(2,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::lnrpc::UnlockWalletRequest, ::lnrpc::UnlockWalletResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::lnrpc::UnlockWalletRequest* request, ::lnrpc::UnlockWalletResponse* response) { return this->UnlockWallet(context, request, response); }));}
    void SetMessageAllocatorFor_UnlockWallet(
        ::grpc::experimental::MessageAllocator< ::lnrpc::UnlockWalletRequest, ::lnrpc::UnlockWalletResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(2);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(2);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::lnrpc::UnlockWalletRequest, ::lnrpc::UnlockWalletResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_UnlockWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UnlockWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::UnlockWalletRequest* /*request*/, ::lnrpc::UnlockWalletResponse* /*response*/) override {
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerUnaryReactor* UnlockWallet(
      ::grpc::CallbackServerContext* /*context*/, const ::lnrpc::UnlockWalletRequest* /*request*/, ::lnrpc::UnlockWalletResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* UnlockWallet(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::lnrpc::UnlockWalletRequest* /*request*/, ::lnrpc::UnlockWalletResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_ChangePassword : public BaseClass {
   ...
   public:
    ExperimentalWithCallbackMethod_ChangePassword() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(3,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::lnrpc::ChangePasswordRequest, ::lnrpc::ChangePasswordResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::lnrpc::ChangePasswordRequest* request, ::lnrpc::ChangePasswordResponse* response) { return this->ChangePassword(context, request, response); }));}
    void SetMessageAllocatorFor_ChangePassword(
        ::grpc::experimental::MessageAllocator< ::lnrpc::ChangePasswordRequest, ::lnrpc::ChangePasswordResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(3);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(3);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::lnrpc::ChangePasswordRequest, ::lnrpc::ChangePasswordResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* ChangePassword(
      ::grpc::CallbackServerContext* /*context*/, const ::lnrpc::ChangePasswordRequest* /*request*/, ::lnrpc::ChangePasswordResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* ChangePassword(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::lnrpc::ChangePasswordRequest* /*request*/, ::lnrpc::ChangePasswordResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_GenSeed<ExperimentalWithCallbackMethod_InitWallet<ExperimentalWithCallbackMethod_UnlockWallet<ExperimentalWithCallbackMethod_ChangePassword<Service > > > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_GenSeed<ExperimentalWithCallbackMethod_InitWallet<ExperimentalWithCallbackMethod_UnlockWallet<ExperimentalWithCallbackMethod_ChangePassword<Service > > > > ExperimentalCallbackService;
  template <class BaseClass>
  class WithGenericMethod_GenSeed : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_GenSeed() {
      ::grpc::Service::MarkMethodGeneric(0);
    }
    ~WithGenericMethod_GenSeed() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GenSeed(::grpc::ServerContext* /*context*/, const ::lnrpc::GenSeedRequest* /*request*/, ::lnrpc::GenSeedResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithGenericMethod_InitWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_InitWallet() {
      ::grpc::Service::MarkMethodGeneric(1);
    }
    ~WithGenericMethod_InitWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status InitWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::InitWalletRequest* /*request*/, ::lnrpc::InitWalletResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithGenericMethod_UnlockWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_UnlockWallet() {
      ::grpc::Service::MarkMethodGeneric(2);
    }
    ~WithGenericMethod_UnlockWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UnlockWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::UnlockWalletRequest* /*request*/, ::lnrpc::UnlockWalletResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_GenSeed : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_GenSeed() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_GenSeed() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GenSeed(::grpc::ServerContext* /*context*/, const ::lnrpc::GenSeedRequest* /*request*/, ::lnrpc::GenSeedResponse* /*response*/) override {
    ...
    void RequestGenSeed(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_InitWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_InitWallet() {
      ::grpc::Service::MarkMethodRaw(1);
    }
    ~WithRawMethod_InitWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status InitWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::InitWalletRequest* /*request*/, ::lnrpc::InitWalletResponse* /*response*/) override {
    ...
    void RequestInitWallet(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(1, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class WithRawMethod_UnlockWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_UnlockWallet() {
      ::grpc::Service::MarkMethodRaw(2);
    }
    ~WithRawMethod_UnlockWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UnlockWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::UnlockWalletRequest* /*request*/, ::lnrpc::UnlockWalletResponse* /*response*/) override {
    ...
    void RequestUnlockWallet(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(2, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_GenSeed : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_GenSeed() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->GenSeed(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_GenSeed() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GenSeed(::grpc::ServerContext* /*context*/, const ::lnrpc::GenSeedRequest* /*request*/, ::lnrpc::GenSeedResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_InitWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_InitWallet() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(1,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->InitWallet(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_InitWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status InitWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::InitWalletRequest* /*request*/, ::lnrpc::InitWalletResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_UnlockWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_UnlockWallet() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(2,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->UnlockWallet(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_UnlockWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UnlockWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::UnlockWalletRequest* /*request*/, ::lnrpc::UnlockWalletResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_GenSeed : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_GenSeed() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::lnrpc::GenSeedRequest, ::lnrpc::GenSeedResponse>(std::bind(&WithStreamedUnaryMethod_GenSeed<BaseClass>::StreamedGenSeed, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_GenSeed() override {
      BaseClassMustBeDerivedFromService(this);
    }
    ...
    virtual ::grpc::Status StreamedGenSeed(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::lnrpc::GenSeedRequest,::lnrpc::GenSeedResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  class WithStreamedUnaryMethod_InitWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_InitWallet() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler< ::lnrpc::InitWalletRequest, ::lnrpc::InitWalletResponse>(std::bind(&WithStreamedUnaryMethod_InitWallet<BaseClass>::StreamedInitWallet, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_InitWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status InitWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::InitWalletRequest* /*request*/, ::lnrpc::InitWalletResponse* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedInitWallet(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::lnrpc::InitWalletRequest,::lnrpc::InitWalletResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  class WithStreamedUnaryMethod_UnlockWallet : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_UnlockWallet() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::internal::StreamedUnaryHandler< ::lnrpc::UnlockWalletRequest, ::lnrpc::UnlockWalletResponse>(std::bind(&WithStreamedUnaryMethod_UnlockWallet<BaseClass>::StreamedUnlockWallet, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_UnlockWallet() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status UnlockWallet(::grpc::ServerContext* /*context*/, const ::lnrpc::UnlockWalletRequest* /*request*/, ::lnrpc::UnlockWalletResponse* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedUnlockWallet(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::lnrpc::UnlockWalletRequest,::lnrpc::UnlockWalletResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_ChangePassword() {
      ::grpc::Service::MarkMethodStreamed(3,
        new ::grpc::internal::StreamedUnaryHandler< ::lnrpc::ChangePasswordRequest, ::lnrpc::ChangePasswordResponse>(std::bind(&WithStreamedUnaryMethod_ChangePassword<BaseClass>::StreamedChangePassword, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedChangePassword(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::lnrpc::ChangePasswordRequest,::lnrpc::ChangePasswordResponse>* server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_GenSeed<WithStreamedUnaryMethod_InitWallet<WithStreamedUnaryMethod_UnlockWallet<WithStreamedUnaryMethod_ChangePassword<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GenSeed<WithStreamedUnaryMethod_InitWallet<WithStreamedUnaryMethod_UnlockWallet<WithStreamedUnaryMethod_ChangePassword<Service > > > > StreamedService;
};
  ...
  class WithAsyncMethod_SendPayment : public BaseClass {
   ...
   public:
    ...
    void RequestSendPayment(::grpc::ServerContext* context, ::grpc::ServerAsyncReaderWriter< ::lnrpc::SendResponse, ::lnrpc::SendRequest>* stream, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncBidiStreaming(26, context, stream, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  class WithAsyncMethod_SendToRoute : public BaseClass {
   ...
   public:
    ...
    void RequestSendToRoute(::grpc::ServerContext* context, ::grpc::ServerAsyncReaderWriter< ::lnrpc::SendResponse, ::lnrpc::SendToRouteRequest>* stream, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncBidiStreaming(28, context, stream, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
